...
> **Coursework Context:** Developed as part of the individual evaluation criteria for the **CSD34203 Project Portfolio** module at **Universiti Sultan Zainal Abidin (UniSZA)**.
...
* **Cyberpunk Aurora Dark Mode:** A dark, high-fidelity theme designed specifically for a creative developer. It utilizes a custom 3D blueprint layout background, glassmorphism UI cards, and colorful neon halos representing game development aesthetics.
...
* **Structured Content Architecture:** Split seamlessly across 4 professional core modules:
    1.  `index.html` (Home Hero & Dynamic Project Highlights)
    2.  `about.html` (Academic Background, Key Courses & Skill Matrices)
    3.  `blog.html` (Technical Devlogs & Media Production Retrospectives)
    4.  `contact.html` (Twin-column Interactive Form & Professional Handles)
...
### 2. "Kemas Bilik" (3D Animation Production)
A comprehensive character and environmental animation project. Focused heavily on mastering keyframe constraints, spatial object interactions, interior scene lighting layers, and comedic comedic/daily-life timeline tracking built completely from scratch inside **Blender**.
* **Watch Project:** [Kemas Bilik on YouTube](https://youtu.be/vMZ0JrDwrUI?si=cM7tmSqGlwUA1l7z)

### 3. "Dying Water" (Digital Audio & Video Short Film)
A cinematic short film project demonstrating deep post-production workflows. Focus areas include technical color grading matching specific emotional narratives, soundscape engineering, and real-time multi-layered background audio synchronization.
* **Watch Project:** [Dying Water on YouTube](https://youtu.be/ESLF7iKi7tE?si=UEPJbZP993nDXEoN)
...
* **Version Control & Deployment:** Git, GitHub Pages Ecosystem
